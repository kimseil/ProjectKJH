...
public class LocationGuideActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        ArrayList<DTOLocationGuide> data = new ArrayList<>();
        /*
        ...
        */
        ...
        data.add(new DTOLocationGuide("p1.png", "정말 유용한\nOOO 정보와 팁", info));
        ...
        data.add(new DTOLocationGuide("p2.png", "볼거리, 즐길거리의\n모든 것", info));
        ...
        data.add(new DTOLocationGuide("p3.png", "OOO\n먹킷리스트", info));
